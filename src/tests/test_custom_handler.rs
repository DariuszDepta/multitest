...
use crate::test_helpers::TestCustomMsg;
...
fn custom_handler_works() {
    ...
    let custom_handler = CachingCustomHandler::<TestCustomMsg, TestCustomMsg>::new();
